...
namespace Common
{
    ...
    public class Utils
    {
        ...
        public static string TimeDifference(DateTime DateTime1)
        {
            ...
            //显示时间   
            return dateDiff = ts.Days.ToString() + "天" + ts.Hours.ToString() + "小时" + ts.Minutes.ToString() + "分钟" + ts.Seconds.ToString() + "秒";
